...
public class HRM_Head_Employee 
{
	...
	// xpath to clich on employee button in dachboard
	 ...
	 @FindBy(xpath="//select[@name='employee_department']") private WebElement empDepartment;
	 
	 @FindBy(xpath="//select[@name='employee_branches']") private WebElement empBranches;
...
public WebElement getEmpDepartment() {
	return empDepartment;
}

public WebElement getEmpBranches() {
	return empBranches;
}
...
public WebElement getEmployeeSaveButton() {
 ...
 public void createEmployeeMethod(WebDriver driver,String empid, String fname, String lname, String mname,String bdate,
		 String rdate,String empposition, String empnumber,String sss, String tin, String pagbg, String empgsis, String file201,String empimg, String visibletextDept,String visibletextBranch )
 {
	 ...
	 web_Util.selectElementInDropdown(visibletextDept,empDepartment);    // text
	 web_Util.selectElementInDropdown(visibletextBranch,empBranches); 
	 employeePosition.sendKeys(empposition);
